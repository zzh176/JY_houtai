  ...
  <div class="index">
    <div class="head">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item class="line">员工管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="sou">
      <el-input class="inp1 inp" v-model="input" placeholder="账号"></el-input>
      <el-input class="inp2 inp" v-model="input" placeholder="姓名"></el-input>

...
<template>
  <div class="index">
    ...
    <div class="sou">
      <el-input class="inp1 inp" v-model="input" placeholder="商品名称"></el-input>
      <el-input class="inp2 inp" v-model="input" placeholder="商品编号"></el-input>
    ...
    <div class="footer">
      <el-table :data="list" height="500" border style="width: 100%">
        ...
        <el-table-column prop="purchasePrice" label="进货价" width="100"></el-table-column>
